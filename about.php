					...
					<div class="about span_1_of_2">
						<div class="about-top">
							<div class="grid images_3_of_2" data-sr>
								<img src="<?php echo $movie['image']; ?>" alt="Movie Poster" width='350' height='500' alt="" />
							</div>
							<div class="desc span_3_of_2" data-sr>
								<h2 class="text-center movie-title"><?php echo $movie['movie_name']; ?></h2>
								<p class="p-link"><b>IMDB Rating: 4.5 <i class='bx bxs-star'></i></b></p>
						...
						if (mysqli_num_rows($s)) { ?>
							<table class="table table-hover table-bordered text-center show-table" data-sr>
								...
								<thead>
									<tr>
										<th class="text-center"><b>Theatre</b></th>
										<th class="text-center"><b>Show Timings</b></th>
									</tr>
								</thead>
								<?php
						...
						?>
							<h3 style="color: #444; font-size: 23px;" class="text-center" data-sr>Currently there are no shows available!</h3>
							<p class="text-center" data-sr>Please check back later!</p>
						<?php
						}
						?>
					</div>
